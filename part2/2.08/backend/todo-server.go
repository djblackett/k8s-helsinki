...
func main() {
	...
	// Create
	//db.Create(&Todo{Id: 1, Text: "Welcome to your new todo list", Completed: false})
	//db.Create(&Todo{Id: 2, Text: "Tap the sun to switch to light mode", Completed: false})
	//db.Create(&Todo{Id: 3, Text: "Tap the circles to mark items Completed", Completed: false})
